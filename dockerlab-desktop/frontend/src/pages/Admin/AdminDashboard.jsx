...
const AdminDashboard = () => {
  ...
  const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlIjoiYWRtaW4iLCJpYXQiOjE3NDQwMDMyMjgsImV4cCI6MTc0NDA4OTYyOH0.iK5ZE1hlApv7EkEFZgnTeOgVd7v7UaTZbheqUqsm_Gw'; // Replace with dynamic token if needed
